...
if __name__ == '__main__':
    ...
    user = User.objects.create_superuser('admin', 'admin@163.com', 'admin')
    category_list = ['python学习笔记', '开源项目', '工具资源', '程序员生活感悟',
                     'test category']
    ...
    Post.objects.create(
        title='Markdown 与 代码高亮测试',
        body=pathlib.Path(BASE_DIR).joinpath('scripts', 'md.sample')
